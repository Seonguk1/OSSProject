...
def home():
    if request.method == 'GET':
        ...
        user1_final_score = scores_per_user.loc[user1_name]['final_score']
        user2_final_score = scores_per_user.loc[user2_name]['final_score']

        session['final_scores'] = {
                'user1_final_score': user1_final_score,
                'user2_final_score': user2_final_score,
            }
        session['user_names'] = {
...
def final_score():
    final_scores = session.get('final_scores', None)
    user_names = session.get('user_names', None)

    return render_template('final_score.html', 
                           user1_final_score=final_scores['user1_final_score'],
                           user2_final_score=final_scores['user2_final_score'],
                           user1_name = user_names['user1_name'],
                           user2_name = user_names['user2_name'],
                           )
